...
export class ReqDashboardComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private routerObj: Router,private SharedServices: SharedService,private ReqDashboardServices: ReqDashboardService,private _snackBar: MatSnackBar){
